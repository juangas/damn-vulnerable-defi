...
describe('[Challenge] Puppet v3', function () {
    ...
    /** SET RPC URL HERE */
    const MAINNET_FORKING_URL = "https://mainnet.infura.io/v3/5c60a832a0154bda87f48d7c5fbcba99";
    ...
    it('Execution', async function () {
        ...
        console.log("Token0 of the pool", await uniswapPool.token0());
        console.log("Token1 of the pool", await uniswapPool.token1());
